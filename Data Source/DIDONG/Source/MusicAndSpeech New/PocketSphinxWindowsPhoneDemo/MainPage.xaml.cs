...
namespace PocketSphinxWindowsPhoneDemo
{
    ...
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        private string[] DigitValues = new string[] { "play", "pause", "stop", "next", "previous", "option", "show list" };
        ...
        void speechRecognizer_resultFound(string result)
        {
            ...
            //Mode = RecognizerMode.Wakeup;// add by Quang 30.12.2015 - Khi chuyen man hinh thi dua ve Wakeup
        }
