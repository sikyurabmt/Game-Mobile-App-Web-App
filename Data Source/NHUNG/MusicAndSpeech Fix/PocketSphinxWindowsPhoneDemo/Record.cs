...
namespace PocketSphinxWindowsPhoneDemo
{
      ...
      class Record
    {
         ...
         public static int indexPage = 1; // 1: MainPage, 2: ListSongPage, 3: PlayListPage, 4 : SettingPage;
         public static string strSpeech = "";
        ...
        public const string WakeupText = "something new";

        private string[] SpeechValues = new string[] { "play", "pause", "stop", "next", "previous", "go option", "go list", "exit please", "close please", "save please", "cancel please", "back please" };
        ...
        void speechRecognizer_resultFound(string result)
        {
            ...
            switch (result)
            {
                ...
                case "go option":
                    ...
                    break;
                case "cancel please":
                    Record.strSpeech = "cancel please";
                    break;
                case "save please":
                    Record.strSpeech = "save please";
                    break;
                case "back please":
                    Record.strSpeech = "back please";
                    break;
                case "close please":
                    Record.strSpeech = "close please";
                    break;
                case "exit please":
                    Record.strSpeech = "exit please";
                    break;
                default:
                    break;
            }
